...
class RayPPOTrainer:
    ...
    def _validate(self):
        ...
        for test_data in self.val_dataloader:
            ...
            # Clear memory after processing each validation batch
            del test_batch, test_gen_batch, test_gen_batch_padded, test_output_gen_batch_padded, test_output_gen_batch
            del output_ids, output_texts, result, reward_tensor, scores
            gc.collect()
        ...
        gc.collect()
        if torch.cuda.is_available():
            aggressive_empty_cache(force_sync=False, max_retries=2)
