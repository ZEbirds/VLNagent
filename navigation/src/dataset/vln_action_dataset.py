# Adopted from: https://github.com/InternRobotics/StreamVLN/blob/main/streamvln/dataset/vln_action_dataset.py
import os
import torch
import json
import copy
...
class VLNActionDataset(Dataset):
    ...
    def __getitem__(self, i):
        try:
            ...
            print(e)
            print(f"Encounted error when process {i}-th example: {data['video']}, use {backup_idx}-th example instead!!!")
